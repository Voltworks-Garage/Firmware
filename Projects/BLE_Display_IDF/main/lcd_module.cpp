...
void LCD_Init(void) {
  ...
  // gpio_set_level(GPIO_NUM_46, 1); // Power on the LCD

  // gpio_set_direction(GPIO_NUM_16, GPIO_MODE_OUTPUT);
  // gpio_set_level(GPIO_NUM_16, 1); // Power on the backlight

  vTaskDelay(pdMS_TO_TICKS(1)); // Wait for power to stabilize
