...
# 47 "mcc_generated_files/reset.c" 2
...
# 48 "mcc_generated_files/reset.c" 2
# 1 "mcc_generated_files/reset.h" 1
# 49 "mcc_generated_files/reset.h"
# 1 "mcc_generated_files/reset_types.h" 1
# 59 "mcc_generated_files/reset_types.h"
typedef enum tagERROR_TYPE
{
    RESET_ERROR_RCON_TRAPR = 1,
    RESET_ERROR_RCON_IOPUWR = 2,

    RESET_ERROR_RCON_CM = 3,
    RESET_ERROR_RCON_WDTO_ISR = 4
}RESET_TYPES;
# 77 "mcc_generated_files/reset_types.h"
...
# 50 "mcc_generated_files/reset.h" 2
# 58 "mcc_generated_files/reset.h"
uint16_t RESET_GetCause(void);
# 69 "mcc_generated_files/reset.h"
void RESET_CauseHandler(void);
# 79 "mcc_generated_files/reset.h"
void RESET_CauseClearAll();
# 49 "mcc_generated_files/reset.c" 2
# 57 "mcc_generated_files/reset.c"
static _Bool RESET_CauseFromSoftware(uint16_t resetCause);
static _Bool RESET_CauseFromWatchdogTimer(uint16_t resetCause);
static _Bool RESET_CauseFromConfigurationMismatch(uint16_t resetCause);
static _Bool RESET_CauseFromIllegalOpcode(uint16_t resetCause);
static _Bool RESET_CauseFromExternal(uint16_t resetCause);
static _Bool RESET_CauseFromTrap(uint16_t resetCause);
