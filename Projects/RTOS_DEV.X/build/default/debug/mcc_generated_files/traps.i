...
# 1 "c:\\program files\\microchip\\xc16\\v2.10\\bin\\bin\\../..\\include/bits/alltypes.h" 1 3 4
# 17 "c:\\program files\\microchip\\xc16\\v2.10\\bin\\bin\\../..\\include/bits/alltypes.h" 3 4
...
# 51 "mcc_generated_files/traps.c" 2
# 73 "mcc_generated_files/traps.c"
...
void __attribute__((weak, interrupt,no_auto_psv)) _OscillatorFail(void)
{
    INTCON1bits.OSCFAIL = 0;
    TRAPS_halt_on_error(TRAPS_OSC_FAIL);
}

void __attribute__((weak, interrupt,no_auto_psv)) _StackError(void)
{
...
void __attribute__((weak, interrupt,no_auto_psv)) _AddressError(void)
{
    INTCON1bits.ADDRERR = 0;
    TRAPS_halt_on_error(TRAPS_ADDRESS_ERR);
}

void __attribute__((weak, interrupt,no_auto_psv)) _MathError(void)
{
    INTCON1bits.MATHERR = 0;
    TRAPS_halt_on_error(TRAPS_MATH_ERR);
}

void __attribute__((weak, interrupt,no_auto_psv)) _DMACError(void)
{
    INTCON1bits.DMACERR = 0;
    TRAPS_halt_on_error(TRAPS_DMAC_ERR);
}

void __attribute__((weak, interrupt,no_auto_psv)) _HardTrapError(void)
{
    INTCON4bits.SGHT = 0;
    TRAPS_halt_on_error(TRAPS_HARD_ERR);
}

void __attribute__((weak, interrupt,no_auto_psv)) _SoftTrapError(void)
{
    if(INTCON3bits.NAE)
    {
      INTCON3bits.NAE = 0;
