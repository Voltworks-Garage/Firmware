	.file "C:\\REPOS\\Voltworks_Garage\\Firmware\\Projects\\RTOS_DEV.X\\timertest.c"
...
.LFB1:
	...
	mov	_TMR4,w0
	.loc 1 98 0
	mov	_usSettleCount.9287,w1
	sub	w1,#4,[w15]
	.set ___BP___,50
	bra	leu,.L2
	.loc 1 102 0
	mov	_usLastCount.9286,w1
	sub	w0,w1,w1
	.loc 1 108 0
	mov	_usMaxJitter,w2
	sub	w2,w1,[w15]
...
.L2:
	.loc 1 117 0
	inc	w1,w1
	mov	w1,_usSettleCount.9287
.L3:
	.loc 1 122 0
	mov	w0,_usLastCount.9286
	.loc 1 123 0
	return	
	.set ___PA___,0
.LFE1:
...
_usMaxJitter:
	.skip	2
	.align	2
	.type	_usSettleCount.9287,@object
	.size	_usSettleCount.9287, 2
_usSettleCount.9287:
	.skip	2
	.align	2
	.type	_usLastCount.9286,@object
	.size	_usLastCount.9286, 2
_usLastCount.9286:
	.skip	2
