# 1 "../../RTOS/FreeRTOS/Source/portable/MemMang/heap_1.c"
# 1 "C:\\REPOS\\Voltworks_Garage\\Firmware\\Projects\\RTOS_DEV.X"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../RTOS/FreeRTOS/Source/portable/MemMang/heap_1.c"
# 37 "../../RTOS/FreeRTOS/Source/portable/MemMang/heap_1.c"
...
int clearenv(void);
# 38 "../../RTOS/FreeRTOS/Source/portable/MemMang/heap_1.c" 2
...
# 45 "../../RTOS/FreeRTOS/Source/portable/MemMang/heap_1.c" 2
...
# 46 "../../RTOS/FreeRTOS/Source/portable/MemMang/heap_1.c" 2
# 63 "../../RTOS/FreeRTOS/Source/portable/MemMang/heap_1.c"
    static uint8_t ucHeap[ ( ( size_t ) 5120 ) ];
...
void * pvPortMalloc( size_t xWantedSize )
{
    ...
    static uint8_t * pucAlignedHeap = ((void*)0);



    {
        if( xWantedSize & ( 0x0001 ) )
        {

            if( ( xWantedSize + ( 2 - ( xWantedSize & ( 0x0001 ) ) ) ) > xWantedSize )
            {
                xWantedSize += ( 2 - ( xWantedSize & ( 0x0001 ) ) );
            }
            else
            {
                xWantedSize = 0;
    ...
    vTaskSuspendAll();
    {
        if( pucAlignedHeap == ((void*)0) )
        {

            pucAlignedHeap = ( uint8_t * ) ( ( ( uint16_t ) & ucHeap[ 2 - 1 ] ) & ( ~( ( uint16_t ) ( 0x0001 ) ) ) );
        }


        if( ( xWantedSize > 0 ) &&
            ( ( xNextFreeByte + xWantedSize ) < ( ( ( size_t ) 5120 ) - 2 ) ) &&
    ...
    ( void ) xTaskResumeAll();
# 126 "../../RTOS/FreeRTOS/Source/portable/MemMang/heap_1.c"
    return pvReturn;
}
...
size_t xPortGetFreeHeapSize( void )
{
    return( ( ( ( size_t ) 5120 ) - 2 ) - xNextFreeByte );
}
