# 1 "../../RTOS/FreeRTOS/Demo/Common/Minimal/BlockQ.c"
# 1 "C:\\REPOS\\Voltworks_Garage\\Firmware\\Projects\\RTOS_DEV.X"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../RTOS/FreeRTOS/Demo/Common/Minimal/BlockQ.c"
# 51 "../../RTOS/FreeRTOS/Demo/Common/Minimal/BlockQ.c"
...
int clearenv(void);
# 52 "../../RTOS/FreeRTOS/Demo/Common/Minimal/BlockQ.c" 2
...
# 55 "../../RTOS/FreeRTOS/Demo/Common/Minimal/BlockQ.c" 2
...
# 56 "../../RTOS/FreeRTOS/Demo/Common/Minimal/BlockQ.c" 2
...
# 57 "../../RTOS/FreeRTOS/Demo/Common/Minimal/BlockQ.c" 2
...
# 60 "../../RTOS/FreeRTOS/Demo/Common/Minimal/BlockQ.c" 2
# 69 "../../RTOS/FreeRTOS/Demo/Common/Minimal/BlockQ.c"
...
void vStartBlockingQueueTasks( UBaseType_t uxPriority )
{
    ...
    const TickType_t xBlockTime = ( ( TickType_t) ( ( ( TickType_t) ( ( TickType_t ) 1000 ) )) * ((( TickType_t) ( ( TickType_t ) 1000 ) ) / ( TickType_t) 1000 ));
    ...
    xTaskCreate( vBlockingQueueConsumer, "QConsB1", ( 105 ), ( void * ) pxQueueParameters1, uxPriority, ((void*)0) );
    xTaskCreate( vBlockingQueueProducer, "QProdB2", ( 105 ), ( void * ) pxQueueParameters2, ( ( UBaseType_t ) 0U ), ((void*)0) );
    ...
    xTaskCreate( vBlockingQueueConsumer, "QConsB3", ( 105 ), ( void * ) pxQueueParameters3, ( ( UBaseType_t ) 0U ), ((void*)0) );
    xTaskCreate( vBlockingQueueProducer, "QProdB4", ( 105 ), ( void * ) pxQueueParameters4, uxPriority, ((void*)0) );
    ...
    xTaskCreate( vBlockingQueueProducer, "QProdB5", ( 105 ), ( void * ) pxQueueParameters5, ( ( UBaseType_t ) 0U ), ((void*)0) );
    xTaskCreate( vBlockingQueueConsumer, "QConsB6", ( 105 ), ( void * ) pxQueueParameters6, ( ( UBaseType_t ) 0U ), ((void*)0) );
}
...
static void vBlockingQueueProducer( void *pvParameters )
{
    ...
    for( ; ; )
    {
        ...
        {
            sErrorEverOccurred = ( ( BaseType_t ) 1 );
        }
        else
        {
...
# 252 "../../RTOS/FreeRTOS/Demo/Common/Minimal/BlockQ.c"
        }
    }
}
...
# 271 "../../RTOS/FreeRTOS/Demo/Common/Minimal/BlockQ.c"
