# 1 "../../RTOS/FreeRTOS/Demo/Common/Minimal/crflash.c"
# 1 "C:\\REPOS\\Voltworks_Garage\\Firmware\\Projects\\RTOS_DEV.X"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../RTOS/FreeRTOS/Demo/Common/Minimal/crflash.c"
# 56 "../../RTOS/FreeRTOS/Demo/Common/Minimal/crflash.c"
...
# 57 "../../RTOS/FreeRTOS/Demo/Common/Minimal/crflash.c" 2
# 1 "../../RTOS/FreeRTOS/Source/include/croutine.h" 1
# 36 "../../RTOS/FreeRTOS/Source/include/croutine.h"
...
# 37 "../../RTOS/FreeRTOS/Source/include/croutine.h" 2
# 47 "../../RTOS/FreeRTOS/Source/include/croutine.h"
...
# 136 "../../RTOS/FreeRTOS/Source/include/croutine.h"
BaseType_t xCoRoutineCreate( crCOROUTINE_CODE pxCoRoutineCode,
                             UBaseType_t uxPriority,
                             UBaseType_t uxIndex );
# 181 "../../RTOS/FreeRTOS/Source/include/croutine.h"
void vCoRoutineSchedule( void );
# 735 "../../RTOS/FreeRTOS/Source/include/croutine.h"
void vCoRoutineAddToDelayedList( TickType_t xTicksToDelay,
                                 List_t * pxEventList );
# 745 "../../RTOS/FreeRTOS/Source/include/croutine.h"
BaseType_t xCoRoutineRemoveFromEventList( const List_t * pxEventList );
# 58 "../../RTOS/FreeRTOS/Demo/Common/Minimal/crflash.c" 2
# 1 "../../RTOS/FreeRTOS/Source/include/queue.h" 1
# 43 "../../RTOS/FreeRTOS/Source/include/queue.h"
...
# 44 "../../RTOS/FreeRTOS/Source/include/queue.h" 2
...
# 657 "../../RTOS/FreeRTOS/Source/include/queue.h"
BaseType_t xQueueGenericSend( QueueHandle_t xQueue,
                              const void * const pvItemToQueue,
                              TickType_t xTicksToWait,
                              const BaseType_t xCopyPosition ) ;
# 755 "../../RTOS/FreeRTOS/Source/include/queue.h"
BaseType_t xQueuePeek( QueueHandle_t xQueue,
                       void * const pvBuffer,
                       TickType_t xTicksToWait ) ;
# 791 "../../RTOS/FreeRTOS/Source/include/queue.h"
BaseType_t xQueuePeekFromISR( QueueHandle_t xQueue,
                              void * const pvBuffer ) ;
# 884 "../../RTOS/FreeRTOS/Source/include/queue.h"
BaseType_t xQueueReceive( QueueHandle_t xQueue,
                          void * const pvBuffer,
                          TickType_t xTicksToWait ) ;
# 903 "../../RTOS/FreeRTOS/Source/include/queue.h"
UBaseType_t uxQueueMessagesWaiting( const QueueHandle_t xQueue ) ;
# 922 "../../RTOS/FreeRTOS/Source/include/queue.h"
UBaseType_t uxQueueSpacesAvailable( const QueueHandle_t xQueue ) ;
# 938 "../../RTOS/FreeRTOS/Source/include/queue.h"
void vQueueDelete( QueueHandle_t xQueue ) ;
# 1323 "../../RTOS/FreeRTOS/Source/include/queue.h"
...
BaseType_t xQueueGiveFromISR( QueueHandle_t xQueue,
                              BaseType_t * const pxHigherPriorityTaskWoken ) ;
# 1417 "../../RTOS/FreeRTOS/Source/include/queue.h"
...
# 1438 "../../RTOS/FreeRTOS/Source/include/queue.h"
...
# 1549 "../../RTOS/FreeRTOS/Source/include/queue.h"
    QueueHandle_t xQueueGenericCreate( const UBaseType_t uxQueueLength,
                                       const UBaseType_t uxItemSize,
                                       const uint8_t ucQueueType ) ;
# 1615 "../../RTOS/FreeRTOS/Source/include/queue.h"
QueueSetHandle_t xQueueCreateSet( const UBaseType_t uxEventQueueLength ) ;
# 1639 "../../RTOS/FreeRTOS/Source/include/queue.h"
BaseType_t xQueueAddToSet( QueueSetMemberHandle_t xQueueOrSemaphore,
                           QueueSetHandle_t xQueueSet ) ;
# 1659 "../../RTOS/FreeRTOS/Source/include/queue.h"
BaseType_t xQueueRemoveFromSet( QueueSetMemberHandle_t xQueueOrSemaphore,
                                QueueSetHandle_t xQueueSet ) ;
# 1696 "../../RTOS/FreeRTOS/Source/include/queue.h"
...
# 59 "../../RTOS/FreeRTOS/Demo/Common/Minimal/crflash.c" 2


# 1 "../../RTOS/FreeRTOS/Demo/Common/include/partest.h" 1
# 32 "../../RTOS/FreeRTOS/Demo/Common/include/partest.h"
void vParTestInitialise( void );
void vParTestSetLED( UBaseType_t uxLED,
                     BaseType_t xValue );
void vParTestToggleLED( UBaseType_t uxLED );
# 62 "../../RTOS/FreeRTOS/Demo/Common/Minimal/crflash.c" 2
# 1 "../../RTOS/FreeRTOS/Demo/Common/include/crflash.h" 1
# 80 "../../RTOS/FreeRTOS/Demo/Common/include/crflash.h"
...
# 63 "../../RTOS/FreeRTOS/Demo/Common/Minimal/crflash.c" 2
# 84 "../../RTOS/FreeRTOS/Demo/Common/Minimal/crflash.c"
...
static BaseType_t xCoRoutineFlashStatus = ( ( ( BaseType_t ) 1 ) );
...
UBaseType_t uxIndex;
 ...
 if( uxNumberToCreate > 8 )
 {
  uxNumberToCreate = 8;
 }


 xFlashQueue = xQueueGenericCreate( ( 1 ), ( sizeof( UBaseType_t ) ), ( ( ( uint8_t ) 0U ) ) );
 ...
 if( xFlashQueue )
 {
  ...
  {
   xCoRoutineCreate( prvFixedDelayCoRoutine, 0, uxIndex );
  }


  xCoRoutineCreate( prvFlashCoRoutine, 1, 0 );
 }
}
...
static const TickType_t xFlashRates[ 8 ] = { 150 / ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) ),
                200 / ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) ),
                250 / ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) ),
                300 / ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) ),
                350 / ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) ),
                400 / ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) ),
                450 / ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) ),
                500 / ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) ) };
 ...
 for( ;; )
 {
  ...
  { *( &xResult ) = xQueueCRSend( ( xFlashQueue ), ( ( void * ) &uxIndex ), ( 0 ) ); if( *( &xResult ) == ( -4 ) ) { ( ( CRCB_t * ) ( ( xHandle ) ) )->uxState = ( 152 * 2 ); return; case ( 152 * 2 ):; *&xResult = xQueueCRSend( ( xFlashQueue ), ( ( void * ) &uxIndex ), 0 ); } if( *&xResult == ( -5 ) ) { ( ( CRCB_t * ) ( ( xHandle ) ) )->uxState = ( ( 152 * 2 ) + 1 ); return; case ( ( 152 * 2 ) + 1 ):; *&xResult = ( ( ( BaseType_t ) 1 ) ); } };
  ...
  if( xResult != ( ( ( BaseType_t ) 1 ) ) )
  {
   ...
   xCoRoutineFlashStatus = ( ( ( BaseType_t ) 0 ) );
  }

  if( ( xFlashRates[ uxIndex ] ) > 0 ) { vCoRoutineAddToDelayedList( ( xFlashRates[ uxIndex ] ), ((void*)0) ); } ( ( CRCB_t * ) ( ( xHandle ) ) )->uxState = ( 162 * 2 ); return; case ( 162 * 2 ):;;
 }
...
UBaseType_t uxLEDToFlash;
 ...
 for( ;; )
 {
  ...
  { *( &xResult ) = xQueueCRReceive( ( xFlashQueue ), ( &uxLEDToFlash ), ( ( TickType_t ) 0xffff ) ); if( *( &xResult ) == ( -4 ) ) { ( ( CRCB_t * ) ( ( xHandle ) ) )->uxState = ( 184 * 2 ); return; case ( 184 * 2 ):; *( &xResult ) = xQueueCRReceive( ( xFlashQueue ), ( &uxLEDToFlash ), 0 ); } if( *( &xResult ) == ( -5 ) ) { ( ( CRCB_t * ) ( ( xHandle ) ) )->uxState = ( ( 184 * 2 ) + 1 ); return; case ( ( 184 * 2 ) + 1 ):; *( &xResult ) = ( ( ( BaseType_t ) 1 ) ); } };
