# 1 "../../RTOS/FreeRTOS/Demo/Common/Minimal/integer.c"
# 1 "C:\\REPOS\\Voltworks_Garage\\Firmware\\Projects\\RTOS_DEV.X"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../RTOS/FreeRTOS/Demo/Common/Minimal/integer.c"
# 34 "../../RTOS/FreeRTOS/Demo/Common/Minimal/integer.c"
...
int clearenv(void);
# 35 "../../RTOS/FreeRTOS/Demo/Common/Minimal/integer.c" 2
...
# 38 "../../RTOS/FreeRTOS/Demo/Common/Minimal/integer.c" 2
...
# 39 "../../RTOS/FreeRTOS/Demo/Common/Minimal/integer.c" 2
...
# 42 "../../RTOS/FreeRTOS/Demo/Common/Minimal/integer.c" 2
# 58 "../../RTOS/FreeRTOS/Demo/Common/Minimal/integer.c"
...
void vStartIntegerMathTasks( UBaseType_t uxPriority )
{
    ...
    {
        xTaskCreate( vCompeteingIntMathTask, "IntMath", ( 105 ), ( void * ) &( xTaskCheck[ sTask ] ), uxPriority, ( TaskHandle_t * ) ((void*)0) );
    }
}
...
static void vCompeteingIntMathTask( void *pvParameters )
{
    ...
    for( ; ; )
    {
        ...
        lValue = ( ( long ) 123 );
        lValue += ( ( long ) 234567 );
# 108 "../../RTOS/FreeRTOS/Demo/Common/Minimal/integer.c"
        lValue *= ( ( long ) -3 );
        lValue /= ( ( long ) 7 );
