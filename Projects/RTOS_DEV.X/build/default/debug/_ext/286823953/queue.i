# 1 "../../RTOS/FreeRTOS/Source/queue.c"
# 1 "C:\\REPOS\\Voltworks_Garage\\Firmware\\Projects\\RTOS_DEV.X"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../RTOS/FreeRTOS/Source/queue.c"
# 27 "../../RTOS/FreeRTOS/Source/queue.c"
...
int clearenv(void);
# 28 "../../RTOS/FreeRTOS/Source/queue.c" 2
...
# 29 "../../RTOS/FreeRTOS/Source/queue.c" 2
...
# 36 "../../RTOS/FreeRTOS/Source/queue.c" 2
...
# 37 "../../RTOS/FreeRTOS/Source/queue.c" 2
...
# 38 "../../RTOS/FreeRTOS/Source/queue.c" 2
...
# 41 "../../RTOS/FreeRTOS/Source/queue.c" 2
# 67 "../../RTOS/FreeRTOS/Source/queue.c"
...
# 98 "../../RTOS/FreeRTOS/Source/queue.c"
...
# 131 "../../RTOS/FreeRTOS/Source/queue.c"
} xQUEUE;



typedef xQUEUE Queue_t;
# 174 "../../RTOS/FreeRTOS/Source/queue.c"
...
static void prvCopyDataFromQueue( Queue_t * const pxQueue,
                                  void * const pvBuffer ) ;
# 217 "../../RTOS/FreeRTOS/Source/queue.c"
static void prvInitialiseNewQueue( const UBaseType_t uxQueueLength,
                                   const UBaseType_t uxItemSize,
                                   uint8_t * pucQueueStorage,
                                   const uint8_t ucQueueType,
                                   Queue_t * pxNewQueue ) ;
# 294 "../../RTOS/FreeRTOS/Source/queue.c"
BaseType_t xQueueGenericReset( QueueHandle_t xQueue,
                               BaseType_t xNewQueue )
{
    ...
    if( ( pxQueue != ((void*)0) ) &&
        ...
        ( ( 65535U / pxQueue->uxLength ) >= pxQueue->uxItemSize ) )
    {
        vPortEnterCritical();
        {
...
# 426 "../../RTOS/FreeRTOS/Source/queue.c"
    QueueHandle_t xQueueGenericCreate( const UBaseType_t uxQueueLength,
                                       const UBaseType_t uxItemSize,
                                       const uint8_t ucQueueType )
    {
        ...
        if( ( uxQueueLength > ( UBaseType_t ) 0 ) &&
            ...
            ( ( 65535U / uxQueueLength ) >= uxItemSize ) &&

            ( ( 65535U - sizeof( Queue_t ) ) >= ( uxQueueLength * uxItemSize ) ) )
        {



            xQueueSizeInBytes = ( size_t ) ( uxQueueLength * uxItemSize );
# 454 "../../RTOS/FreeRTOS/Source/queue.c"
...
# 472 "../../RTOS/FreeRTOS/Source/queue.c"
...
# 534 "../../RTOS/FreeRTOS/Source/queue.c"
    ;
}
# 833 "../../RTOS/FreeRTOS/Source/queue.c"
BaseType_t xQueueGenericSend( QueueHandle_t xQueue,
                              const void * const pvItemToQueue,
                              TickType_t xTicksToWait,
                              const BaseType_t xCopyPosition )
{
    ...
    ;
    ;
# 854 "../../RTOS/FreeRTOS/Source/queue.c"
    for( ; ; )
    {
        vPortEnterCritical();
        {
            ...
            {
                ;
# 927 "../../RTOS/FreeRTOS/Source/queue.c"
                {
                                     ...
                                     const BaseType_t xCopyPosition )
{
    ...
    ;
    ;
# 1072 "../../RTOS/FreeRTOS/Source/queue.c"
    ;
    ...
    uxSavedInterruptStatus = 0;
    {
        if( ( pxQueue->uxMessagesWaiting < pxQueue->uxLength ) || ( xCopyPosition == ( ( BaseType_t ) 2 ) ) )
        {
            ...
            if( cTxLock == ( ( int8_t ) -1 ) )
            {
# 1158 "../../RTOS/FreeRTOS/Source/queue.c"
                {
                    if( ( ( ( &( pxQueue->xTasksWaitingToReceive ) )->uxNumberOfItems == ( UBaseType_t ) 0 ) ? ( ( BaseType_t ) 1 ) : ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 0 ) )
                    {
                        if( xTaskRemoveFromEventList( &( pxQueue->xTasksWaitingToReceive ) ) != ( ( BaseType_t ) 0 ) )
            ...
            else
            {
                ...
                { const UBaseType_t uxNumberOfTasks = uxTaskGetNumberOfTasks(); if( ( UBaseType_t ) ( cTxLock ) < uxNumberOfTasks ) { ; ( pxQueue )->cTxLock = ( int8_t ) ( ( cTxLock ) + ( int8_t ) 1 ); } };
            }
                              ...
                              BaseType_t * const pxHigherPriorityTaskWoken )
{
    ...
    ;
# 1248 "../../RTOS/FreeRTOS/Source/queue.c"
    ;
    ...
    uxSavedInterruptStatus = 0;
    {
        ...
        if( uxMessagesWaiting < pxQueue->uxLength )
        {
            ...
            if( cTxLock == ( ( int8_t ) -1 ) )
            {
# 1327 "../../RTOS/FreeRTOS/Source/queue.c"
                {
                    if( ( ( ( &( pxQueue->xTasksWaitingToReceive ) )->uxNumberOfItems == ( UBaseType_t ) 0 ) ? ( ( BaseType_t ) 1 ) : ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 0 ) )
                    {
                        if( xTaskRemoveFromEventList( &( pxQueue->xTasksWaitingToReceive ) ) != ( ( BaseType_t ) 0 ) )
                          ...
                          TickType_t xTicksToWait )
{
    ...
    ;
# 1401 "../../RTOS/FreeRTOS/Source/queue.c"
    for( ; ; )
    {
        vPortEnterCritical();
        {
                                ...
                                TickType_t xTicksToWait )
{
    ...
    ;
# 1547 "../../RTOS/FreeRTOS/Source/queue.c"
    for( ; ; )
    {
        vPortEnterCritical();
        {
...
# 1582 "../../RTOS/FreeRTOS/Source/queue.c"
                if( ( ( ( &( pxQueue->xTasksWaitingToSend ) )->uxNumberOfItems == ( UBaseType_t ) 0 ) ? ( ( BaseType_t ) 1 ) : ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 0 ) )
                {
                    if( xTaskRemoveFromEventList( &( pxQueue->xTasksWaitingToSend ) ) != ( ( BaseType_t ) 0 ) )
                    {
        ...
        if( xTaskCheckForTimeOut( &xTimeOut, &xTicksToWait ) == ( ( BaseType_t ) 0 ) )
        {
            ...
            {
                ;
# 1661 "../../RTOS/FreeRTOS/Source/queue.c"
                vTaskPlaceOnEventList( &( pxQueue->xTasksWaitingToReceive ), xTicksToWait );
                prvUnlockQueue( pxQueue );
        ...
        else
        {
            ...
            if( prvIsQueueEmpty( pxQueue ) != ( ( BaseType_t ) 0 ) )
            {
# 1717 "../../RTOS/FreeRTOS/Source/queue.c"
                ;
                return ( ( BaseType_t ) 0 );
            }
            else
                       ...
                       TickType_t xTicksToWait )
{
    ...
    ;
# 1755 "../../RTOS/FreeRTOS/Source/queue.c"
    for( ; ; )
    {
        vPortEnterCritical();
        {
                                 ...
                                 BaseType_t * const pxHigherPriorityTaskWoken )
{
    ...
    ;
    ;
# 1905 "../../RTOS/FreeRTOS/Source/queue.c"
    ;
    ...
    uxSavedInterruptStatus = 0;
    {
        ...
        if( uxMessagesWaiting > ( UBaseType_t ) 0 )
        {
            ...
            else
            {
                ...
                { const UBaseType_t uxNumberOfTasks = uxTaskGetNumberOfTasks(); if( ( UBaseType_t ) ( cRxLock ) < uxNumberOfTasks ) { ; ( pxQueue )->cRxLock = ( int8_t ) ( ( cRxLock ) + ( int8_t ) 1 ); } };
            }
                              ...
                              void * const pvBuffer )
{
    ...
    ;
    ;
# 1999 "../../RTOS/FreeRTOS/Source/queue.c"
    ;
...
void vQueueDelete( QueueHandle_t xQueue )
{
    ...
    ;
    ;
# 2087 "../../RTOS/FreeRTOS/Source/queue.c"
    {


        vPortFree( pxQueue );
    }
# 2112 "../../RTOS/FreeRTOS/Source/queue.c"
}
# 2173 "../../RTOS/FreeRTOS/Source/queue.c"
static BaseType_t prvCopyDataToQueue( Queue_t * const pxQueue,
                                      const void * pvItemToQueue,
                                      const BaseType_t xPosition )
{
    ...
    {
# 2200 "../../RTOS/FreeRTOS/Source/queue.c"
    }
...
static void prvUnlockQueue( Queue_t * const pxQueue )
{
    ...
    vPortEnterCritical();
    {
        ...
        {
# 2335 "../../RTOS/FreeRTOS/Source/queue.c"
            {
