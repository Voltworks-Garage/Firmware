# 1 "../../RTOS/FreeRTOS/Source/croutine.c"
# 1 "C:\\REPOS\\Voltworks_Garage\\Firmware\\Projects\\RTOS_DEV.X"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../RTOS/FreeRTOS/Source/croutine.c"
# 29 "../../RTOS/FreeRTOS/Source/croutine.c"
...
# 30 "../../RTOS/FreeRTOS/Source/croutine.c" 2
...
# 31 "../../RTOS/FreeRTOS/Source/croutine.c" 2
...
# 32 "../../RTOS/FreeRTOS/Source/croutine.c" 2
# 46 "../../RTOS/FreeRTOS/Source/croutine.c"
    List_t pxReadyCoRoutineLists[ ( 2 ) ];
    List_t xDelayedCoRoutineList1;
    List_t xDelayedCoRoutineList2;
    List_t * pxDelayedCoRoutineList = ((void*)0);
    List_t * pxOverflowDelayedCoRoutineList = ((void*)0);
    List_t xPendingReadyCoRoutineList;


    CRCB_t * pxCurrentCoRoutine = ((void*)0);
    UBaseType_t uxTopCoRoutineReadyPriority = 0;
    TickType_t xCoRoutineTickCount = 0, xLastTickCount = 0, xPassedTicks = 0;
# 81 "../../RTOS/FreeRTOS/Source/croutine.c"
    void prvInitialiseCoRoutineLists( void );
    ...
    void prvCheckPendingReadyList( void );
# 99 "../../RTOS/FreeRTOS/Source/croutine.c"
    void prvCheckDelayedList( void );
    ...
    void prvCheckPendingReadyList( void )
    {
        ...
        while( ( ( ( &xPendingReadyCoRoutineList )->uxNumberOfItems == ( UBaseType_t ) 0 ) ? ( ( BaseType_t ) 1 ) : ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 0 ) )
        {
    ...
    void prvCheckDelayedList( void )
    {
        ...
        while( xPassedTicks )
        {
            ...
            while( ( ( ( pxDelayedCoRoutineList )->uxNumberOfItems == ( UBaseType_t ) 0 ) ? ( ( BaseType_t ) 1 ) : ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 0 ) )
            {
    ...
    void vCoRoutineSchedule( void )
    {
        ...
        if( pxDelayedCoRoutineList != ((void*)0) )
        {
            ...
            while( ( ( ( &( pxReadyCoRoutineLists[ uxTopCoRoutineReadyPriority ] ) )->uxNumberOfItems == ( UBaseType_t ) 0 ) ? ( ( BaseType_t ) 1 ) : ( ( BaseType_t ) 0 ) ) )
            {
