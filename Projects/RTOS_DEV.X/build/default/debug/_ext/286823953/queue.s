	.file "C:\\REPOS\\Voltworks_Garage\\Firmware\\Projects\\RTOS_DEV.X\\..\\..\\RTOS\\FreeRTOS\\Source\\queue.c"
...
_prvCopyDataToQueue:
.LFB15:
	.file 1 "../../RTOS/FreeRTOS/Source/queue.c"
	.loc 1 2176 0
	.set ___PA___,1
	mov.d	w8,[w15++]
.LCFI0:
...
.LCFI6:
	...
	bra	z,.L24
	.loc 1 327 0
; 327 "../../RTOS/FreeRTOS/Source/queue.c" 1
	CALL _vPortYield			
NOP					  
	bra	.L24
.L23:
...
.L38:
	...
	bra	z,.L41
	.loc 1 940 0
; 940 "../../RTOS/FreeRTOS/Source/queue.c" 1
	CALL _vPortYield			
NOP					  
	bra	.L41
.L40:
	...
	bra	z,.L41
	.loc 1 953 0
; 953 "../../RTOS/FreeRTOS/Source/queue.c" 1
	CALL _vPortYield			
NOP					  
.L41:
	.loc 1 962 0
...
.L46:
	...
	bra	nz,.L52
	.loc 1 1022 0
; 1022 "../../RTOS/FreeRTOS/Source/queue.c" 1
	CALL _vPortYield			
NOP					  
	bra	.L52
.L48:
...
.LBB9:
	...
	bra	z,.L73
	.loc 1 1423 0
; 1423 "../../RTOS/FreeRTOS/Source/queue.c" 1
	CALL _vPortYield			
NOP					  
.L73:
	.loc 1 1435 0
...
.L78:
	...
	bra	nz,.L84
	.loc 1 1483 0
; 1483 "../../RTOS/FreeRTOS/Source/queue.c" 1
	CALL _vPortYield			
NOP					  
	bra	.L84
.L80:
...
.LBB10:
	...
	bra	z,.L88
	.loc 1 1586 0
; 1586 "../../RTOS/FreeRTOS/Source/queue.c" 1
	CALL _vPortYield			
NOP					  
.L88:
	.loc 1 1598 0
...
.L93:
	...
	bra	nz,.L99
	.loc 1 1666 0
; 1666 "../../RTOS/FreeRTOS/Source/queue.c" 1
	CALL _vPortYield			
NOP					  
	bra	.L99
.L95:
...
.LBB11:
	...
	bra	z,.L103
	.loc 1 1783 0
; 1783 "../../RTOS/FreeRTOS/Source/queue.c" 1
	CALL _vPortYield			
NOP					  
.L103:
	.loc 1 1795 0
...
.L108:
	...
	bra	nz,.L114
	.loc 1 1844 0
; 1844 "../../RTOS/FreeRTOS/Source/queue.c" 1
	CALL _vPortYield			
NOP					  
	bra	.L114
.L110:
...
.LCFI33:
	...
	mov	w0,_SRbits
	nop	
; 2491 "../../RTOS/FreeRTOS/Source/queue.c" 1
	NOP
	.loc 1 2493 0
	mov	w8,w0
	rcall	_prvIsQueueFull
...
.L133:
	...
	mov	w0,_SRbits
	nop	
; 2514 "../../RTOS/FreeRTOS/Source/queue.c" 1
	NOP
	.loc 1 2516 0
	mov	[w8+28],w2
	mov	[w8+30],w1
...
.LCFI34:
	...
	mov	w0,_SRbits
	nop	
; 2570 "../../RTOS/FreeRTOS/Source/queue.c" 1
	NOP
	.loc 1 2572 0
	mov	[w8+28],w0
	cp0	w0
...
.L141:
	...
	mov	w0,_SRbits
	nop	
; 2597 "../../RTOS/FreeRTOS/Source/queue.c" 1
	NOP
	.loc 1 2599 0
	mov	[w8+28],w1
	.loc 1 2641 0
...
.Letext0:
	...
	.file 6 "../../RTOS/FreeRTOS/Source/include/task.h"
	.file 7 "../../RTOS/FreeRTOS/Source/include/queue.h"
	.section	.debug_info,info
	.4byte	0x1390
	.2byte	0x2
	...
	.byte	0x1
	.asciz	"../../RTOS/FreeRTOS/Source/queue.c"
