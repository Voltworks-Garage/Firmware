	.file "C:\\REPOS\\Voltworks_Garage\\Firmware\\Projects\\RTOS_DEV.X\\..\\..\\RTOS\\FreeRTOS\\Source\\tasks.c"
...
_prvIdleTask:
.LFB29:
	.file 1 "../../RTOS/FreeRTOS/Source/tasks.c"
	.loc 1 3428 0
	.set ___PA___,0
	mov	w8,[w15++]
.LCFI0:
...
.L3:
	...
	bra	leu,.L2
	.loc 1 3469 0
; 3469 "../../RTOS/FreeRTOS/Source/tasks.c" 1
	CALL _vPortYield			
NOP					  
.L2:
.LBB2:
...
.LBE3:
	...
	bra	z,.L14
	.loc 1 1653 0
; 1653 "../../RTOS/FreeRTOS/Source/tasks.c" 1
	CALL _vPortYield			
NOP					  
.L14:
	.loc 1 1665 0
...
.LBE4:
	...
	bra	ltu,.L29
	.loc 1 1853 0
; 1853 "../../RTOS/FreeRTOS/Source/tasks.c" 1
	CALL _vPortYield			
NOP					  
.L29:
	.loc 1 1865 0
...
.LFB11:
	...
	mov	w0,_SRbits
	nop	
; 2084 "../../RTOS/FreeRTOS/Source/tasks.c" 1
	NOP
	.loc 1 2085 0
...
.LBE16:
	...
	bra	geu,.L78
	.loc 1 1096 0
; 1096 "../../RTOS/FreeRTOS/Source/tasks.c" 1
	CALL _vPortYield			
NOP					  
.L78:
	.loc 1 1107 0
...
.LFB10:
	...
	mov	w0,_SRbits
	nop	
; 2026 "../../RTOS/FreeRTOS/Source/tasks.c" 1
	NOP
	.loc 1 2036 0
...
.LBE30:
	...
	bra	z,.L116
	.loc 1 2267 0
; 2267 "../../RTOS/FreeRTOS/Source/tasks.c" 1
	CALL _vPortYield			
NOP					  
	.loc 1 2264 0
	mov	#1,w8
...
.L141:
	...
	bra	z,.L143
	.loc 1 1747 0
; 1747 "../../RTOS/FreeRTOS/Source/tasks.c" 1
	CALL _vPortYield			
NOP					  
	bra	.L137
.L143:
...
.LBE33:
	...
	bra	leu,.L156
	.loc 1 4950 0
; 4950 "../../RTOS/FreeRTOS/Source/tasks.c" 1
	CALL _vPortYield			
NOP					  
.L156:
	.loc 1 4962 0
...
.LCFI39:
	...
	.loc 1 4795 0
; 4795 "../../RTOS/FreeRTOS/Source/tasks.c" 1
	CALL _vPortYield			
NOP					  
.L203:
	.loc 1 4807 0
...
.LCFI41:
	...
	rcall	_prvAddCurrentTaskToDelayedList
	.loc 1 4716 0
; 4716 "../../RTOS/FreeRTOS/Source/tasks.c" 1
	CALL _vPortYield			
NOP					  
.L208:
	.loc 1 4728 0
...
.L214:
	.loc 1 1333 0
; 1333 "../../RTOS/FreeRTOS/Source/tasks.c" 1
	CALL _vPortYield			
NOP					  
.L213:
	.loc 1 1339 0
...
.LBE42:
	...
	bra	nz,.L223
	.loc 1 1286 0
; 1286 "../../RTOS/FreeRTOS/Source/tasks.c" 1
	CALL _vPortYield			
NOP					  
.L223:
	.loc 1 1294 0
...
.Letext0:
	...
	.file 4 "../../RTOS/FreeRTOS/Source/include/projdefs.h"
	.file 5 "../../RTOS/FreeRTOS/Source/include/../../Source/portable/MPLAB/PIC24_dsPIC/portmacro.h"
	.file 6 "../../RTOS/FreeRTOS/Source/include/list.h"
	.file 7 "../../RTOS/FreeRTOS/Source/include/task.h"
	.section	.debug_info,info
	.4byte	0x1e3f
	.2byte	0x2
	...
	.byte	0x1
	.asciz	"../../RTOS/FreeRTOS/Source/tasks.c"
