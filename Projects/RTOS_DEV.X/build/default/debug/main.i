...
# 262 "c:\\program files\\microchip\\xc16\\v2.10\\bin\\bin\\../..\\include/bits/alltypes.h" 3 4
typedef int ssize_t;
# 453 "c:\\program files\\microchip\\xc16\\v2.10\\bin\\bin\\../..\\include/bits/alltypes.h" 3 4
...
# 1 "mcc_generated_files/system.h" 1
# 49 "mcc_generated_files/system.h"
...
# 42 "c:\\program files\\microchip\\xc16\\v2.10\\bin\\bin\\../..\\support\\generic\\h/builtins.h" 3 4
...
# 43 "c:\\program files\\microchip\\xc16\\v2.10\\bin\\bin\\../..\\support\\generic\\h/builtins.h" 2 3 4
...
# 50 "mcc_generated_files/system.h" 2

# 1 "mcc_generated_files/system_types.h" 1
# 62 "mcc_generated_files/system_types.h"
...
# 1 "../../RTOS/FreeRTOS/Demo/Common/include/BlockQ.h" 1
# 30 "../../RTOS/FreeRTOS/Demo/Common/include/BlockQ.h"
...
# 73 "main.c" 2
# 1 "../../RTOS/FreeRTOS/Demo/Common/include/blocktim.h" 1
# 30 "../../RTOS/FreeRTOS/Demo/Common/include/blocktim.h"
void vCreateBlockTimeTasks( void );
BaseType_t xAreBlockTimeTestTasksStillRunning( void );
# 74 "main.c" 2
# 1 "../../RTOS/FreeRTOS/Demo/Common/include/integer.h" 1
# 30 "../../RTOS/FreeRTOS/Demo/Common/include/integer.h"
...
int main( void )
{
 ...
 vStartBlockingQueueTasks( ( ( ( UBaseType_t ) 0U ) + 2 ) );
 vStartIntegerMathTasks( ( ( UBaseType_t ) 0U ) );
 vStartFlashCoRoutines( ( 3 ) );
 vCreateBlockTimeTasks();


 xTaskCreate( vCheckTask, "Check", ( ( 105 ) * 4 ), ((void*)0), ( ( ( UBaseType_t ) 0U ) + 3 ), ((void*)0) );
...
static char cStringBuffer[ ( 20 ) ];



unsigned short usErrorDetected = ( ( BaseType_t ) 0 );
 ...
 for( ;; )
 {
  ...
  do { ( void ) xTaskDelayUntil( ( &xLastExecutionTime ), ( ( ( TickType_t ) 3000 / ( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) ) ) ) ); } while( 0 );



  if( xAreIntegerMathsTaskStillRunning() != ( ( BaseType_t ) 1 ) )
  {
   usErrorDetected = ( ( BaseType_t ) 1 );
   sprintf( cStringBuffer, "FAIL #1" );
  }

  if( xAreBlockTimeTestTasksStillRunning() != ( ( BaseType_t ) 1 ) )
  {
   usErrorDetected = ( ( BaseType_t ) 1 );
  ...
  if( usErrorDetected == ( ( BaseType_t ) 0 ) )
  {


   sprintf( cStringBuffer, "%dns max jitter", ( short ) ( usMaxJitter - ( ( ( unsigned long ) ((120000000UL) / 2) ) / ( 20000 ) ) ) * ( ( unsigned short ) ( ( 1.0 / ( double ) ( ( unsigned long ) ((120000000UL) / 2) ) ) * 1000000000.0 ) ) );
  }
