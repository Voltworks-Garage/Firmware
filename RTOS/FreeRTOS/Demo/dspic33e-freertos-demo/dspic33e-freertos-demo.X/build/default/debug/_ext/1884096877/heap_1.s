...
.L2:
	...
	.loc 1 96 0
	cp0	_pucAlignedHeap.9744
	.set ___BP___,85
	bra	nz,.L3
	.loc 1 99 0
	mov	#_ucHeap+1,w0
	bclr	w0,#0
	mov	w0,_pucAlignedHeap.9744
.L3:
	.loc 1 73 0
	clr	w9
	.loc 1 103 0
...
_ucHeap:
	...
	.section	.nbss,bss,near
	.align	2
	.type	_pucAlignedHeap.9744,@object
	.size	_pucAlignedHeap.9744, 2
_pucAlignedHeap.9744:
	.skip	2
