...
# 66 "../../Common/Minimal/comtest.c" 2
# 1 "../../Common/include/comtest.h" 1
# 30 "../../Common/include/comtest.h"
...
# 68 "../../Common/Minimal/comtest.c" 2
# 95 "../../Common/Minimal/comtest.c"
static xComPortHandle xPort = ((void*)0);
                            ...
                            UBaseType_t uxLED )
{
    ...
    uxBaseLED = uxLED;
    xSerialPortInitMinimal( ulBaudRate, ( ( UBaseType_t ) ( ( 'X' ) - ( 'A' ) ) + ( UBaseType_t ) 1 ) );


    xTaskCreate( vComTxTask, "COMTx", ( 105 ), ((void*)0), uxPriority - 1, ( TaskHandle_t * ) ((void*)0) );
    xTaskCreate( vComRxTask, "COMRx", ( 105 ), ((void*)0), uxPriority, ( TaskHandle_t * ) ((void*)0) );
}
...
static void vComTxTask( void *pvParameters )
{
    ...
    for( ; ; )
    {
        ...
        {
            if( xSerialPutChar( xPort, cByteToSend, ( ( TickType_t ) 0 ) ) == ( ( ( BaseType_t ) 1 ) ) )
            {
                vParTestToggleLED( uxBaseLED + ( 0 ) );
            }
        }


        vParTestSetLED( uxBaseLED + ( 0 ), ( ( BaseType_t ) 0 ) );




        xTimeToWait = xTaskGetTickCount() + ( ( TickType_t ) 3 );


        xTimeToWait %= ( ( TickType_t ) 0x96 );


        if( xTimeToWait < ( ( TickType_t ) 0x32 ) )
        {
...
static void vComRxTask( void *pvParameters )
{
    ...
    BaseType_t xResyncRequired = ( ( BaseType_t ) 0 ), xErrorOccurred = ( ( BaseType_t ) 0 );
    ...
    for( ; ; )
    {
        ...
        for( cExpectedByte = ( 'A' ); cExpectedByte <= ( 'X' ); cExpectedByte++ )
        {
            ...
            if( xSerialGetChar( xPort, &cByteRxed, ( ( TickType_t ) 0xffff ) ) )
            {
                ...
                {
                    vParTestToggleLED( uxBaseLED + ( 1 ) );
                }
                else
                {
                    xResyncRequired = ( ( BaseType_t ) 1 );
                    break;
                }
            }
        }
        ...
        vParTestSetLED( uxBaseLED + ( 1 ), ( ( BaseType_t ) 0 ) );




        if( xResyncRequired == ( ( BaseType_t ) 1 ) )
        {
            while( cByteRxed != ( 'X' ) )
            {

                xSerialGetChar( xPort, &cByteRxed, ( ( TickType_t ) 0xffff ) );
            }
