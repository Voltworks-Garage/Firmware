...
# 1 "../../Common/include/BlockQ.h" 1
# 30 "../../Common/include/BlockQ.h"
...
# 71 "../main.c" 2
# 1 "../../Common/include/integer.h" 1
# 30 "../../Common/include/integer.h"
void vStartIntegerMathTasks( UBaseType_t uxPriority );
BaseType_t xAreIntegerMathsTaskStillRunning( void );
# 72 "../main.c" 2
# 1 "../../Common/include/comtest2.h" 1
# 30 "../../Common/include/comtest2.h"
...
int main( void )
{
 ...
 vStartFlashCoRoutines( ( 5 ) );
 vAltStartComTestTasks( ( 2 ), ( 19200 ), ( 6 ) );
...
unsigned short usErrorDetected = ( ( BaseType_t ) 0 );
 ...
 for( ;; )
 {
  ...
  if( xAreComTestTasksStillRunning() != ( ( BaseType_t ) 1 ) )
  {
   usErrorDetected = ( ( BaseType_t ) 1 );
  ...
  if( usErrorDetected == ( ( BaseType_t ) 0 ) )
  {
   ...
   sprintf( cStringBuffer, "%dns max jitter", ( short ) ( usMaxJitter - ( ( ( unsigned long ) 25000000 ) / ( 20000 ) ) ) * ( ( unsigned short ) ( ( 1.0 / ( double ) ( ( unsigned long ) 25000000 ) ) * 1000000000.0 ) ) );
  }


  xQueueGenericSend( ( xLCDQueue ), ( &xMessage ), ( ( TickType_t ) 0xffff ), ( ( BaseType_t ) 0 ) );
 }
}
