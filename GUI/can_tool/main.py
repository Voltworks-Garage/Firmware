...
try:
    from .config import Config, load_plugins, default_config
    from .gui.main_app import CANApp
except ImportError:
    from can_tool.config import Config, load_plugins, default_config
...
def create_standalone_app(custom_config: dict = None):
    """
